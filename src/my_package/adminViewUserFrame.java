 ...
 * @author user
 */
public class adminViewUserFrame extends javax.swing.JFrame {

    /**
     * Creates new form MainFrame
     */
   DBHelper db = new DBHelper();
    public adminViewUserFrame() {
       initComponents();
       try {
           db.connectDB();
       } catch (Exception ex) {
           Logger.getLogger(adminViewUserFrame.class.getName()).log(Level.SEVERE, null, ex);
       }
    }
    ...
    private void initComponents() {
        ...
        tblUser.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fullname", "Username", "Password", "Phone", "Gender", "Address", "UserID"
            }
        ));
    ...
    private void btnDisplayAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDisplayAllActionPerformed
          ...
          try {
           ...
           ResultSet rs = db.displayAllUsers();
           /*
           int count = 0;
           try {
           while(rs.next()){
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
         try {
           ...
           ResultSet rs = db.displayByUsername(des);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        // TODO add your handling code here:
             ...
             String dest = tblUser.getValueAt(row, 6).toString();
        
            boolean fhj = Boolean.parseBoolean(dest);
            fhj = true;
            adminUpdateUserFrame hj = new adminUpdateUserFrame();
             hj.setVisible(fhj);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
         ...
         if(db.deleteUserByTouristId(dest)){
             JOptionPane.showConfirmDialog(null, "are you sure you want to delete this user? ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminViewUserFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminViewUserFrame().setVisible(true);
            }
        });
    }
